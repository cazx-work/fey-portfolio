...
const moments: BeyondCodeMoment[] = [
  {
    ...
    narrative:
      'The work is meaningful, but it is only one part of life. Time with my wife and the people I love gives everything else its shape—and makes the difficult days feel worthwhile.',
    label: '01 / together',
  },
  {
    ...
    title: 'Shared quiet',
    narrative:
      'Some memories are defined by who was there and how little needed to be said. A sunset may be ordinary, but sharing the stillness makes it worth remembering.',
    label: '02 / stillness',
  },
  {
    ...
    narrative:
      'Some parts of life refuse to be scheduled. Bingo is a reminder that attention is not only something to manage—it is also something to give freely when a curious puppy asks for it.',
  ...
  },
  {
    ...
    narrative:
      'Coffee, water, and a few quiet minutes create a welcome counterweight to technical work. The ritual is simple: settle in, notice what is in front of me, and let the next idea arrive without forcing it.',
    label: '04 / ritual',
  },
  {
    ...
    narrative:
      'A good view changes the pace of a day. Near the water, the horizon gives small problems a larger frame and creates the kind of perspective that is difficult to find at a desk.',
  ...
  },
  {
    ...
    narrative:
      'The smallest details can hold the whole mood of a place. Flowers in the foreground, a distant ridge, and changing weather invite me to pay attention before moving on.',
    label: '06 / attention',
  },
  {
    ...
    narrative:
      'Being outdoors makes progress feel physical again: a path, a bridge, a little uncertainty, and a destination that does not need to be rushed. It is a welcome change from measuring everything in tasks.',
    label: '07 / outdoors',
  },
  {
    ...
    narrative:
      'A car is practical, but it also represents possibility: a free afternoon, an unfamiliar road, and the freedom to turn a nearby place into a small adventure together.',
    label: '08 / movement',
  },
  {
    ...
    narrative:
      'Transitions are their own kind of place. On a ferry at sunset, there is nowhere to optimize for a while—only the crossing, the light, and the anticipation of arriving somewhere new.',
    label: '09 / transition',
  },
];
...
export function BeyondCodeCarousel() {
  ...
  const railIndexes = [-3, -2, -1, 0, 1, 2, 3, 4].map(
    (offset) => (activeIndex + offset + moments.length) % moments.length,
  );
  ...
  return (
    ...
    >
      <nav
        className="beyond-code-carousel__rail"
        aria-label="Choose a visual journal entry"
      >
        {railIndexes.map((index) => (
          ...
          >
            <MediaImage
              ...
              fill
              loading="lazy"
              sizes="(max-width: 48rem) 4rem, 7rem"
            />
          </button>
        ))}
      </nav>
      ...
      <div className="beyond-code-carousel__main">
        ...
        >
          ...
          <div
            className="beyond-code-carousel__controls beyond-code-carousel__controls--mobile"
            aria-label="Photo navigation"
          >
            <button
              type="button"
              onClick={() => showMoment(activeIndex - 1)}
        ...
        <div className="beyond-code-carousel__copy" aria-live="polite">
          ...
          <div className="beyond-code-carousel__controls beyond-code-carousel__controls--desktop">
            <button
              ...
              aria-label="Previous photo"
            >
              <InlineIcon name="arrow-left" /> <span>Previous</span>
            </button>
            <button
              type="button"
              onClick={() => showMoment(activeIndex + 1)}
              aria-label="Next photo"
            >
              <span>Next</span> <InlineIcon name="arrow-right" />
            </button>
          </div>
        </div>
      </div>
